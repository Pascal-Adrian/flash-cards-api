...
async def create_category(category_create: CategoryCreate, db=Depends(get_db)):
...
async def update_category(id: int, category_update: CategoryCreate, db=Depends(get_db)):
